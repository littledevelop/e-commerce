...
$ob = new controller; 
// echo @$page_name = $_SERVER['page_name'];
echo @$query_string = $_SERVER['QUERY_STRING'];
//to check user
$msg = $ob -> user_login();
echo "<br>";
// echo @$page_name= basename($_SERVER['PHP_SELF']);
...
<!-- Mirrored from p.w3layouts.com/demos/june-2016/01-06-2016/big_store/web/login.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 07:01:54 GMT -->
...
<!--login-->
	...
	<div class="login">
		...
		<div class="main-agileits">
            ...
            <input type="text" name="query_string" value="<?php echo $query_string; ?>" style="display:none ;>
...
<!-- smooth scrolling -->
	...
	<a hr*ef="#" id="toTop" style="display: block;"> <span id="toTopHover" style="opacity: 1;"> </span></a>
<!-- //smooth scrolling -->
