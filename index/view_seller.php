                                 ...
                                 <div class="enter_post col-lg-12 ">
                                    <form id="myForm" method="get" enctype="multipart/form-data">
                                       ...
                                       <div class="pull-right">
                                        <a href="add_seller.php" class="btn btn-info btn-icon bottom15 right15"><i class="fa fa-newspaper-o" style="font-size: x-large;"></i> &nbsp; <span style="font-size: large;">Add Seller</span></a>
                     ...
                     <div class="row">
                        <div class="col-xs-12">
                           ...
                           <table class="table table-striped" id="example2" >
                              ...
                              <tbody>
                                 <?php 
                                    while ($fetch=mysqli_fetch_array($disp_seller))
                                    {

                                    ?>
                                 <tr><td>
                                       <a href="add_seller.php?edit=<?php echo $fetch['seller_id'];?>">
                                    ...
                                    <td>
                                       <a href="view_seller.php?delete=<?php echo $fetch['seller_id'];?>" onclick="return confirm('Are You Sure Want To Remove  Seller?')">
                                    ...
                                    <td>
                                       <!-- <div class="col-md-6 bottom15 right15"> -->
                                        <a href="view_seller.php?seller_status=<?php echo $fetch['seller_status'];?>&&seller_id=<?php echo $fetch['seller_id'];?>">
                                            <?php
                                            
                                            if($fetch['seller_status']=='Active')
                                            {
                                            ?>
                                            ...
                                            else if($fetch['seller_status']=='Deactive')
                                            {
                                            ?>
                                    ...
                                    <td><img src="<?php echo $fetch['seller_profile'];?>" height="60" width="60"></td>
                                    <td><?php echo $fetch['seller_name'];?></td>
                                    <td><?php echo $fetch['seller_email'];?></td>
                                    <td><?php echo $fetch['seller_mobile'];?></td>
                                    <td><?php echo $fetch['seller_address'];?></td>
