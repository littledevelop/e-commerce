...
<html class=" ">
   ...
   <head>
      ...
      <meta charset="utf-8" />
      <title>Web Master Admin : reason Details</title>
                                 ...
                                 <div class="enter_post col-lg-12 ">
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="pull-right">
                                        <a href="add_reason.php" class="btn btn-info btn-icon bottom15 right15"><i class="fa fa-newspaper-o" style="font-size: x-large;"></i> &nbsp; <span style="font-size: large;">Add Reason</span></a>
                           ...
                           <table class="table table-striped" id="example2" >
                              ...
                              <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <a href="add_reason.php?edit=<?php echo $fetch['reason_id'];?>">
                                    ...
                                    <td>
                                       <a href="view_reason.php?delete=<?php echo $fetch['reason_id'];?>" onclick="return confirm('Are You Sure Want To Remove  reason?')">
                                    ...
                                    <td>
                                       <!-- <div class="col-md-6 bottom15 right15"> -->
                                        <a href="view_reason.php?reason_status=<?php echo $fetch['reason_status'];?>&&reason_id=<?php echo $fetch['reason_id'];?>">
                                            <?php
