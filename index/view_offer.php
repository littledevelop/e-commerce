                                 ...
                                 <div class="enter_post col-lg-12 ">
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="pull-right">
                                        <a href="add_offer.php" class="btn btn-info btn-icon bottom15 right15"><i class="fa fa-newspaper-o" style="font-size: x-large;"></i> &nbsp; <span style="font-size: large;">Add offer</span></a>
                     ...
                     <div class="row">
                        <div class="col-xs-12">
                           ...
                           <table class="table table-striped" id="example2" >
                              ...
                              <tbody>
                                 <?php 
                                    while ($fetch=mysqli_fetch_array($disp_offer))
                                    {

                                    ?>
                                 <tr>
                                    <td>
                                       <a href="add_offer.php?edit=<?php echo $fetch['offer_id'];?>">
                                    ...
                                    <td>
                                       <a href="view_offer.php?delete=<?php echo $fetch['offer_id'];?>" onclick="return confirm('Are You Sure Want To Remove  offer?')">
                                    ...
                                    <td>
                                       <!-- <div class="col-md-6 bottom15 right15"> -->
                                        <a href="view_offer.php?offer_status=<?php echo $fetch['offer_status'];?>&&offer_id=<?php echo $fetch['offer_id'];?>">
                                            <?php
                                            if($fetch['offer_status']=='Active')
                                            {
                                            ?>
                                            ...
                                            else if($fetch['offer_status']=='Deactive')
                                            {
                                            ?>
                                    ...
                                    <td style="float: left;"><?php echo $fetch['offer_name'];?></td>
                                    <td ><?php echo $fetch['offer_price'];?></td>
                                    <td ><?php echo $fetch['offer_percentage'];?></td>
                                    <td><?php echo $fetch['offer_desc'];?></td>
