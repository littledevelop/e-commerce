...
<html class=" ">
   ...
   <head>
      ...
      <meta charset="utf-8" />
      <title>Web Master Admin : user Details</title>
                                 ...
                                 <div class="enter_post col-lg-12 ">
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                       ...
                                       <div class="pull-right">
                                        <a href="add_user.php" class="btn btn-info btn-icon bottom15 right15"><i class="fa fa-newspaper-o" style="font-size: x-large;"></i> &nbsp; <span style="font-size: large;">Add user</span></a>
                     ...
                     <div class="row">
                        <div class="col-xs-12">
                           ...
                           <table class="table table-striped" id="example-1" >
                              ...
                              <tbody>
                                 <?php 
                                    while ($fetch=mysqli_fetch_array($disp_user))
                                    {

                                    ?>
                                 <tr>
                                    <td>
                                       <a href="add_user.php?edit=<?php echo $fetch['user_id'];?>">
                                    ...
                                    <td>
                                       <a href="view_user.php?delete_user=<?php echo $fetch['user_id'];?>" onclick="return confirm('Are You Sure Want To Remove  user?')">
                                    ...
                                    <td>
                                       <!-- <div class="col-md-6 bottom15 right15"> -->
                                        <a href="view_user.php?user_status=<?php echo $fetch['user_status'];?>&&user_id=<?php echo $fetch['user_id'];?>">
                                            <?php
                                            ...
                                            else if($fetch['user_status']=='Deactive')
                                            {
                                            ?>
                                    ...
                                    <td style="float: left;"><?php echo $fetch['user_id'];?></td>
                                    <td ><img src="<?php echo $fetch['user_profile'];?>" height="30px" width="30px"></td>
                                    <td><?php echo $fetch['user_name'];?></td>
                                    <td  style="float: left;" ><?php echo $fetch['user_email'];?></td>
                                    <td><?php echo $fetch['user_mobile'];?></td>
                                    <td  style="float: left;" ><?php echo $fetch['user_gender'];?></td>
