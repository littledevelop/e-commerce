...
<html class=" ">
   ...
   <head>
      ...
      <meta charset="utf-8" />
      <title>Web Master Admin : order Details</title>
                              ...
                              <div class="uprofile-content row text-center">
                                 <div class="enter_post col-lg-12 ">
                                    <form id="myForm" method="post" enctype="multipart/form-data">
                                     ...
                                     <!--    <a href="add_order.php" class="btn btn-info btn-icon bottom15 right15"><i class="fa fa-newspaper-o" style="font-size: x-large;"></i> &nbsp; <span style="font-size: large;">Add order</span></a>
                                      -->  
                                       </div>
                                        <!-- //data tables -->
                  <div class="content-body">
                        ...
                        <div class="col-xs-12">
                           ...
                           <table class="table table-striped" id="example-1" >
                              ...
                              <tbody>
                                 <?php
                                    $i =1; 
                                    while ($fetch=mysqli_fetch_array($disp_order))
                                    {
                                 ...
                                 <tr>
                                    ...
                                    <td><?php echo $i;?></td>
                                    <td><a href="order_details.php?order_details=<?php echo $fetch['order_no'];?>">  
                                    ...
                                    <td style="float: left;"><?php echo $fetch['order_no'];?></td>
                                    <td ><?php echo $fetch['user_name'];?></td>
                                    <td><?php echo $fetch['user_email'];?></td>
                                    <td><?php echo $fetch['total_pay']; ?></td>
                                    <td><?php echo $fetch['order_method']; ?></td>
                                    <td><?php echo $fetch['order_entry_date'];?></td>
