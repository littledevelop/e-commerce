            ...
            <div class="container">
               <div class="single-top-main">
                  ...
                  <div class="col-md-3 single-top-left" >
                     <div class="">
                        <div id="" >
                           <img src="index/<?php echo $row['product_image'];  ?>"   alt="" class="img-responsive" height="95" width="95"/>
                        </div>
                        <div>
                        </div>
                     </div>
                  ...
                  <div class="col-md-9 single-top ">
                     <div class="single-right">
                        ...
                        <div class="pr-single">
                           ...
                           <p class="reduced " style="font-weight:bold;">QTY <?php echo $row['order_qty']; ?></p>
                        </div>
                        <?php  
                           // $total_prod_amt = $fetch_data['product_price'] * $fetch_data['qty']; 
                           // $total_sell_amt= $fetch_data['selling_price']*$fetch_data['qty']; ?>
                        <h4>
                        <p class="reduced " style="font-weight:bold;"><del><?php echo $row['product_price']; ?></del><?php echo  $row['selling_price']; ?><i class="fa fa-inr"></i></p>
                        <p></p>
                        <br><br>
                        <h4 style="font-weight:bold;color:red "><?php echo $row['order_status'];?></h4>
                        <br><br>
                        <h4><?php echo $row['order_entry_date']; ?></h4>
                     </div>
                  </div>
                  <div class="clearfix"> </div>
                  <br><br>
                  ...
                  <h3 >  Total Payable Amount  :- <b> <?php echo  $disp_payable['total_amount']; ?></b></h3>
                  <br><br>
               </div>
            </div>
         </div>
