                ...
                <center>
                  <div style="font-family:cursive;font-weight: bold;color: blue;">
                   ...
                   <h1 >Personal Information</h1><br><br>
                    ...
                    <div id="picture-frame" >
                           <img src=" <?php echo @$disp_user_data['user_profile']; ?>"  alt="" class="img-responsive" style="height:100;width: 100px;">
                        </div>
                   <br>
                </center>
                   <table align="center" style="font-family:georgia;font-weight:bold;font-size:18px;" class="table table-sm">
                      <tr>
                         <th> Full Name:  </th>
                         <td style="float: left;" > <?php echo  @$disp_user_data['user_name'];?><br></td>
                      </tr>
                        <tr>
                           <th> Email : </th>
                           <td style="float: left;"><?php echo  @$disp_user_data['user_email'];?><br>
                           </td>
                        </tr>
                        <tr>
                           <th> Mobile Number :</th>
                           <td align=""> <?php echo  @$disp_user_data['user_mobile'];?><br></td>
                        </tr>
                        <tr> 
                           <th>Gender :</th>
                           <td><?php echo @$disp_user_data['user_gender']; ?><br></td>
                        </tr>
                        <tr> 
                           <th>Address :</th>
                           <td><?php echo @$disp_user_data['user_address']; ?><br></td>
                        </tr>
                        <tr> 
                           <th>State :</th>
                           <td><?php echo @$disp_user_data['state_name']; ?><br></td>
                        </tr>
                        <tr> 
                           <th>City :</th>
                           <td><?php echo @$disp_user_data['city_name']; ?><br></td>
                        </tr>

                           <tr>
                              <th colspan="2"><a href="edit_profile.php" class="btn btn-danger">EDIT PROFILE</a> </th>
                           </tr>
                   </table>
