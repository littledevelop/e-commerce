   ...
   <body>
      ...
      <body>
         ...
         <h3><?php echo $fetch_data['product_name']; ?></h3>
                          ...
                          <?php if($fetch_data['product_size']!="none")
                          {
                            echo "Size:-". $fetch_data['size']; 
                          }?>
     ...
     <!--     <a href="cart.php?btn_minus=<?php echo $fetch_data['product_id']; ?>"  class="fa fa minus-square-o btn btn-info" style="border-radius: 10px;font-size: 15px;font-weight: bold;" > - </a>
      -->
        ...
        <!--  <a href="cart.php?btn_plus=<?php echo $fetch_data['product_id']; ?>"  class="fa fa plus-square-o btn btn-info" style="border-radius: 10px;font-size: 15px;font-weight: bold;">+</a>
         -->
         ...
         <input type="text" name="qty" readonly="readonly" value="<?php echo $fetch_data['qty']; ?>" style="text-align:center;font-weight: bold;height: 28px;width: 50px;font-size: x-small;border-radius: 5px;">
