...
})(function(h, E, H, k)
{
    ...
    function Ta(a, b, c)
    {
        ...
        0 === f || -1 === e ? d = 0 : "number" === typeof b ? (d = b * e, d > f && (d = 0)) : "first" == b ? d = 0 : "previous" == b ? (d = 0 <= e ? d - e : 0, 0 > d && (d = 0)) : "next" ==
            b ? d + e < f && (d += e) : "last" == b ? d = Math.floor((f - 1) / e) * e : K(a, 0, "Unknown paging action: " + b, 10);
    ...
    t.extend = function(a, b, c)
    {
        if (c.length && b && (b instanceof t || b.__dt_wrapper))
        {
            ...
            {} : f.val, b[f.name].__dt_wrapper = !0, t.extend(a, b[f.name], f.propExt)
        }
    };
