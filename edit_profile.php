         ...
         <style type="text/css">
            ...
            <div class="row">
               <div class="col-lg-3" >
                  <div class="well">
                     ...
                     <div id="picture-frame" >
                           <img src=" <?php echo $disp_user_data['user_profile']; ?>"  alt="" class="img-responsive" style="height:25px;width: 25px;">
                        </div>
               ...
               <div class="col-lg-8" style="overflow:visible;background: --color-white-bg;border-radius: 2px; box-shadow: 2px 2px 2px 2px rgb(0 0 0 / 20%);flex-grow: 3;" >
                <center>
                  <div style="font-family:cursive;font-weight: bold;color: blue;">
                     
                   <h1 >Personal Information</h1><br><br>
                  </div>
                    <div id="picture-frame" >
                           <img src=" <?php echo $disp_user_data['user_profile']; ?>"  alt="" class="img-responsive" style="height:70px;width: 70px;">
                        </div>
                   <br>
                </center>
                <form name="form1" method="post" enctype="multipart/form-data">

                   <table align="center" style="font-family:georgia;font-weight:bold;font-size:18px;" class="table table-sm">
                      <tr>
                         <th> Full Name:</th>
                         <td style="float: left;"><input type="text" name="uname" value="<?php echo @$disp_user_data['user_name'];?>"></td>
                      </tr>
                        <tr>
                           <th> Email :</th>
                           <td style="float: left;"><input type="text" name="email" value="<?php echo @$disp_user_data['user_email'];?>">
                           </td>
                        </tr>
                        <tr>
                           <th> Mobile Number :</th>
                           <td align=""> <input type="text" name="mobile" value="<?php echo @$disp_user_data['user_mobile'];?>"></td>
                        </tr>
                        <tr> 
                           <th>Gender :</th>
                           <td> <?php 
                                 if(@$disp_user_data['user_gender']=='Male')
                                 {
                              ?>
                              ...
                              <?php
                                 ...
                                 else if( @$disp_user_data['user_gender']=='Female')
                                  {
                               ?>
                        ...
                        <tr> 
                           <th>Address :</th>
                           <td><textarea name="address" cols="30" rows="3"><?php echo @$disp_user_data['user_address']; ?></textarea></td>
                        </tr>
                        <tr> 
                           <th>State :</th>
                           <td><select name="state" onchange="get_statewise_city(this.value);">
                              <option value="">Select State</option>
                              <?php while($fetch=mysqli_fetch_array($disp_state))
                                    {
                                             if($fetch['state_id']==@$disp_user_data['user_state'])
                                             {
                                 ?>
                        ...
                        <tr> 
                           <th>City :</th>
                           <td><select name="city" id="get_city">
                              
                                <option value="">Select City</option>

                              <?php
                              $disp_city = $ob->get_city(@$disp_user_data['user_state']);
                                 ?>
                              <option style='display:none;'>Select City</option>
                              <?php
                              while($fetch=mysqli_fetch_array($disp_city))
                                    {
                                             if($fetch['city_id']==@$disp_user_data['user_city'])
                                             {
                                 ?>
                                       <option value="<?php echo $fetch['city_id']; ?>" selected=""><?php echo $fetch['city_name']; ?></option>
                                 <?php
                                             }
                                             else
                                             {
                        ...
                        <tr>
                           <th>Choose File:-</th>
                           <th>   <input type="file" name="profile" data-error="#errprofile"></th>
                           <th>    <img src=" <?php echo @$disp_user_data['user_profile']; ?>"  alt="" class="img-responsive" style="height:70px;width: 70px;"></th>
                        </tr>

                           <tr>
                              <th colspan="2"><input type="submit" name="btn_edit" value="EDIT PROFILE" class="btn btn-danger"></th>
                           </tr>
                   </table>
         </form>
