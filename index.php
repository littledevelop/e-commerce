...
$disp_all_product = $ob->view_all_product();
...
<!-- Mirrored from p.w3layouts.com/demos/june-2016/01-06-2016/big_store/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 07:01:44 GMT -->
...
<div style="position: absolute; z-index: -1; inset: 0px; overflow: hidden; background-size: cover; background-repeat: no-repeat; background-position: 50% 50%; background-image: none;">
	<!-- <video autoplay="" loop="" muted="" style="margin: auto; position: absolute; z-index: -1; top: 50%; left: 50%; transform: translate(-50%, -50%); visibility: visible; width: 904px; height: auto;"> -->
		<!-- <source src="video/video.mp4" type="video/mp4"> -->
		<!-- <source src="video/video.webm" type="video/webm"><source src="video/video.ogv" type="video/ogg"> -->
		<!-- </video> -->
</div>
    ...
    <script>window.jQuery || document.write('<script src="js/vendor/jquery-1.11.1.min.html"><\/script>')</script>
	...
	<div class="container-fluid">
		<div class="spec ">
			...
			<div class="tab-head ">
				<nav class="nav-sidebar">
					<ul class="nav tabs ">
						...
						while($row_data1=mysqli_fetch_array($disp_category) )
						{
							if($i==1)
							{
						//	echo "tab".$row_data1['category_id'];
						?>

					  <li class="active"><a href="#tab<?php echo $row_data1['category_id'] ?>" data-toggle="tab"><?php echo $row_data1['category_name'];?></a></li>
					  	<?php 
					  	}
					  	else
					  	{
					  	?>
					  <li class=""><a href="#tab<?php echo $row_data1['category_id'] ?>" data-toggle="tab"><?php echo $row_data1['category_name'];?></a></li>
						<?php
							}
							$i++;	
						}
				...
				<!-- 	  <li class=""><a href="#tab2" data-toggle="tab">Beauty & Health</a></li> 
					  <li class=""><a href="#tab3" data-toggle="tab">Home</a></li>  
					  <li class=""><a href="#tab4" data-toggle="tab">Mobile & computer</a></li> -->
					</ul>
				</nav>
			...
			<input type="text" name="querystr" value="<?php echo $query_string; ?>" style="display:none ;">
						...
						<?php 
						$i=1;
							while ($row_data = mysqli_fetch_array($disp_all_product)) {
								// code...
								// echo "tab".$row_data['product_category'];
								// if($row_data['category_name']=="Fashions")
								// {
								if($i==1)
								{
							?>
												<div class="tab-pane active text-style" id="tab<?php echo $row_data['product_category'] ?>">
													<div class=" con-w3l">
															<!-- <div class="row"> -->
																<?php
																$disp_prod= $ob->disp_category_product($row_data['product_category']);
																 while($row=mysqli_fetch_array($disp_prod))
																 {

																	?>
															<form name="form<?php echo $row['product_id'];?>" method="post">
																<div class="col-md-3 pro-1">
																		<div class="col-m">								
									<!-- <a data-toggle="modal" href="#myModal">Open Modal</a> -->

																<a href="#myModal<?php echo $row['product_id']; ?>" data-toggle="modal"  class="offer-img">
																	<img src="index/<?php echo $row['product_image']; ?>" class="img-responsive" alt="" style="height: 280px;width: 190px;">
																...
																<div class="mid-1">
																			...
																			<div class="mid-2">
																					<input type="text" name="product_id" value="<?php  echo $row['product_id'];?>" style="display: none;">
																...
																<div class="add add-2">
																		<button type="submit" name="btn_add_to_cart" class="btn btn-danger my-cart-btn my-cart-b" value="<?php echo $row['product_id']; ?>">Add to Cart</button>
							...
							{
								?>
													<div class="tab-pane text-style" id="tab<?php echo $row_data['product_category'] ?>">
													<div class=" con-w3l">
															<!-- <div class="row"> -->
																<?php
																$disp_prod= $ob->disp_category_product($row_data['product_category']);
						 ...
						 <?php
								...
								?>
								<?php 
							include("product_desc_modal.php");
							?>
							<?php
...
<?php
$count_product= $ob->count_product();
while($count_offer = mysqli_fetch_array($count_product))
{
	if($count_offer['1']>=10)
	{
	 $offer_id= $count_offer['offer_id'];

	$disp_product= $ob->disp_offer_product($offer_id);
	while ($row_product = mysqli_fetch_array($disp_product)) {
		// echo $row_product['product_id'];
	?>
	<form name="form<?php echo $row_product['product_id']; ?>" method="post">
		
								<div class="col-md-3 pro-1">
								<div class="col-m">
								<a href="#myModal<?php echo $row_product['product_id']; ?>" data-toggle="modal"  class="offer-img">
										<img src="index/<?php echo $row_product['product_image']; ?>" class="img-responsive" alt="" style="height: 280px;width: 190px;">
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.php?product_id=<?php echo $row_product['product_id'];?>"><?php echo $row_product['product_name'];?></a></h6>							
										</div>
										<input type="text" name="product_id" value="<?php  echo $row['product_id'];?>" style="display: none;">
										<div class="mid-2">
											<p ><label><?php echo $row_product['product_price']; ?></label><em class="item_price"><?php echo $row_product['selling_price']; ?></em></p>
											  <div class="block">
												<div class="starbox small ghosting"> </div>
											</div>
											<div class="clearfix"></div>
											...
											<div class="add add-2">
										   <button class="btn btn-danger my-cart-btn my-cart-b" name="btn_add_to_cart" type="submit" value="<?php  echo $row['product_id'];   ?>" >Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
...
<!-- Mirrored from p.w3layouts.com/demos/june-2016/01-06-2016/big_store/web/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 09 Feb 2022 07:01:53 GMT -->
</html>