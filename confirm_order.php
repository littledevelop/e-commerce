      ...
      <div class="single">
         <div class="container">
            ...
            <div class="single-w3agile">
                     <h2 style="font-family: cursive;color: red;text-decoration: underline;">Your Order Has Been Successfully</h2>
                     <div class="clearfix"></div>
                     <br><br>

                     <h4 style="font-family:georgia sans-serif;color: blueviolet;font-size: 20px;font-weight: bold;"> Your Order Number is <?php echo $query_string; ?></h4>
                     <div class="clearfix"></div>
                     <br><br>
                     <div class="row">
                     ...
                     <h4 ><a href="order.php?<?php echo $query_string; ?>" class="btn btn-success">View Order Details</a></h4>
                     <div class="clearfix"></div>
                  </div>
                     <div class="col-md-6" style="text-align:left;">
                              
                         <h4>  <a href="index.php" class="btn btn-success">Continue To Shopping</a></h4>
                           <div class="clearfix"></div>
                           </div>
                         <br><br> 
                  </div>
